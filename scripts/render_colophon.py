...
# Book identity — override these per-repo
BOOK_NAME = "ebook-email-hardening"
BOOK_TITLE = "邮件系统安全加固"
...
| 发布日期 | {{RELEASE_DATE}} |
| 仓库 | https://github.com/LeisureLinux/ebook-email-hardening |
| 在线阅读 | https://leisurelinux.github.io/ebook-email-hardening/ |
| 许可 | MIT License — © 2026 LeisureLinux |
| 在线预览 | https://leisurelinux.github.io/ebook-email-hardening/ |
